...
namespace FlightManager.Data.Migrations
{
    ...
    [Migration("20210404174036_Create_DB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightManager.Data.Models.Client", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FlightManager.Data.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlightManager.Data.Models.Flight", b =>
                {
                    b.HasOne("FlightManager.Data.Models.Location", "Destination")
                        .WithMany("DestinationFlights")
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("FlightManager.Data.Models.Location", "Origin")
            ...
            modelBuilder.Entity("FlightManager.Data.Models.Reservation", b =>
                {
                    b.HasOne("FlightManager.Data.Models.Client", "Client")
