namespace FlightManager.Web.ViewModels.FlightModels
{
    ...
    public class FlightEditInputModel : IMapFrom<Flight>, IMapTo<Flight>, IMapFrom<FlightDetailsViewModel>, IHaveCustomMappings
    {
        [Required]
        ...
        {
            configuration.CreateMap<FlightEditInputModel, Flight>()
                .ForMember(m => m.Destination, y => y.Ignore())
                .ForMember(m => m.Origin, y => y.Ignore());

            configuration.CreateMap<Flight, FlightEditInputModel>()
